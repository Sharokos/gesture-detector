...
persons = parse_openpose_and_populate_persons("output_json_folder")
...
def plot_gesture_part_xy_vs_frame(gesture_part):
    ...
    """
    filtered_frames = [frame for frame in gesture_part.frames if frame.confidence > 0.7]
